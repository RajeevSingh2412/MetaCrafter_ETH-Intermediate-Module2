...
//         getShipDetails();
//       } catch (error) {
//         console.error("Error fetching total ships: ", error);
//         alert("Failed to fetch total ships. Check console for details.");
//       }
//     }
//   };
...
//       } catch (error) {
//         console.error("Error docking ship: ", error);
//         alert("Failed to dock ship. Check console for details.");
//       }
//     }
//   };
...
//         await tx.wait();
//         getTotalShips();
//         setShipAddress(""); // Clear input after successful undocking
//       } catch (error) {
//         console.error("Error undocking ship: ", error);
//         alert("Failed to undock ship. Check console for details.");
//       }
//     }
//   };
...
//           details.push({ port: i, address: shipAddress === ethers.constants.AddressZero ? "N/A" : shipAddress });
//         } catch (error) {
//           console.error(`Error fetching ship at port ${i}: `, error);
//           details.push({ port: i, address: "Error" });
//         }
//       }
//       setShipDetails(details);
//     }
